---
title: "Course overview — AINS-M6206"
description: "Introduction and module map for Magisterium Thesis (Marketing)"
---

# Course overview — AINS-M6206: Magisterium Thesis (Marketing)

**Term III**

This module sets the scope for **AINS-M6206**. Read the [course syllabus](../) for the full artifact expectations, prerequisite chain, and how PTAH, SAMWISE, AI Faculty, and MCP show up in this course.
